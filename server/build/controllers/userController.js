...
exports.spotifyAuth = exports.refresh = exports.login = exports.join = void 0;
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          _context.next = 7;
          return (0, _firestore.setDoc)((0, _firestore.doc)(_firebase.db, 'firebaseUid', response.user.uid), {
        ...
        case 10:
          ...
          if (!(_context.t0 instanceof _app.FirebaseError)) {
            _context.next = 17;
            break;
          }
...
var login = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var _req$body2, email, password, response;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 8:
          ...
          if (!(_context2.t0 instanceof _app.FirebaseError)) {
            _context2.next = 18;
            break;
          }
...
exports.login = login;
var spotifyAuth = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var WEEK, spotifyApi, _req$body3, code, fuid, response;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          _context3.prev = 2;
          _req$body3 = req.body, code = _req$body3.code, fuid = _req$body3.fuid;
          _context3.next = 6;
          return spotifyApi.authorizationCodeGrant(code);
        case 6:
          response = _context3.sent;
          _context3.next = 9;
          return (0, _firestore.setDoc)((0, _firestore.doc)(_firebase.db, 'firebaseUid', fuid), {
  ...
  return function spotifyAuth(_x5, _x6) {
...
var refresh = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var firebaseUid, docSnap, data, refreshToken, spotifyApi, response;
  ...
  return function refresh(_x7, _x8) {
